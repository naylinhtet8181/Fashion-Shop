           ...
           <div class="cart-view-table">
               ...
               <div class="table-responsive">
                ...
                @forelse($items as $item)
                      <tr>
                        <td><a class="remove" href="{{ route('destroy.cart',['id'=> $item->id]) }}"><fa class="fa fa-close"></fa></a></td>
                        ...
                        <form action="{{ route('update.cart',$item->id)}}" method="POST">
                            @csrf
                            @method('PUT')
                        <td><input type="number" class="qty" name="qty" min="0" size="10px" value="{{ $item->qty }}"></td>
                      ...
                      <tr height="20">
                        <td colspan="6" class="total2">Total  Amount</td>
                        <td>${{ $total_amount }}</td>
                        </tr>
